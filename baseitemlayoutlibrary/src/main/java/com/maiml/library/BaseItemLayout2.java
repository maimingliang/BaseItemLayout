...
public class BaseItemLayout2 extends LinearLayout {
    ...
    public BaseItemLayout2(Context context, AttributeSet attrs) {
        this(context,attrs,0);
    }

    public BaseItemLayout2(Context context, AttributeSet attrs, int defStyleAttr) {
